...
//            .setIcon(Identifier.parse("notexturerotations:icon.png"))
            .addPage(builder.createOptionPage()
                ...
                .addOptionGroup(builder.createOptionGroup()
                    .setName(Component.literal("NoTextureRotations"))
                    .addOption(builder.createBooleanOption(Identifier.parse("notexturerotations:disable_texture_rotations"))
                    ...
                    .addOption(builder.createBooleanOption(Identifier.parse("notexturerotations:disable_offsets"))
                        ...
                        .setDefaultValue(true)
                        .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD))
                    .addOption(builder.createEnumOption(Identifier.parse("notexturerotations:mode"), Config.Mode.class)
